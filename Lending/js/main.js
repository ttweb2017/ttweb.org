...
jQuery(document).on('ready', function() {
	...
	_tg_upcomingeventcounter.countdown('2017/10/02', function(event) {
		var $this = jQuery(this).html(event.strftime(''
			+ '<div class="tg-eventcounter"><span>%-D</span><span> Дней</span></div>'
			+ '<div class="tg-eventcounter"><span>%H</span><span>Часов</span></div>'
			+ '<div class="tg-eventcounter"><span>%M</span><span>Минут</span></div>'
			+ '<div class="tg-eventcounter"><span>%S</span><span>Секунд</span></div>'
		));
	});
	/* -------------------------------------
			NEXT EVENT COUNTER
	...
	_tg_upcomingeventcountervtwo.countdown('2017/10/12', function(event) {
		var $this = jQuery(this).html(event.strftime(''
			+ '<div class="tg-eventcounterholder"><div class="tg-eventcounter"><span>%-D</span><span> Дней</span></div></div>'
			+ '<div class="tg-eventcounterholder"><div class="tg-eventcounter"><span>%H</span><span>Часов</span></div></div>'
			+ '<div class="tg-eventcounterholder"><div class="tg-eventcounter"><span>%M</span><span>Минут</span></div></div>'
			+ '<div class="tg-eventcounterholder"><div class="tg-eventcounter"><span>%S</span><span>Секунд</span></div></div>'
		));
	});
	/* -------------------------------------
			TESTIMONIAL SLIDER
